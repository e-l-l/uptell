...
async def send_maintenance_create_notifications(
    ...
    send_org_notification(
        ...
        user_name=user_name,
        org_name=org_name,
        additional_details=f"Scheduled from {maintenance_data['start_time']} to {maintenance_data['end_time']}",
        exclude_user_id=user.id,
        start_time=str(maintenance_data["start_time"]),
        end_time=str(maintenance_data["end_time"])
    )
